    ...
    def run(self):
        while True:
            ...
            if self.right_clicking:
                tile_pos = str(tile_pos[0]) + ";" + str(tile_pos[1])
                if tile_pos in self.tilemap.tilemap:
                    del self.tilemap.tilemap[tile_pos]

                for tile in self.tilemap.offgrid_titles.copy():
                    ...
                    if tile_r.collidepoint(mpos):
                        self.tilemap.offgrid_titles.remove(tile)
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    if event.button == 1:
                        self.clicking = True
                        if not self.ongrid:
                            self.tilemap.offgrid_titles.append(
                                {
                                    "type": self.tile_list[self.tile_group],
                                    "variant": self.tile_variant,
